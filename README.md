...
这个是做 **电子签约系统**产品时顺手做的免费小工具——只能画一张签名图片，不具备身份核验、合同流转、区块链存证这些法律效力保障。完整版是在线发起、实名认证、手写签名、区块链存证的完整电子签约系统，源码在这：[电子签约系统源码](https://inzyxuashop.com/dianziqianyue-yuanma.html)。
